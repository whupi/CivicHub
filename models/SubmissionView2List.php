 ...
 * Page class
 */
class SubmissionView2List extends SubmissionView2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubmissionView2List";
    ...
    public $FormName = "fsubmission_view2list";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "submissionview2add";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "submissionview2delete";
        $this->MultiUpdateUrl = "submissionview2update";
...
// Use layout
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fsubmission_view2srch");
        }
        ...
        $filterList = Concat($filterList, $this->_Abstract->AdvancedSearch->toJson(), ","); // Field Abstract
        ...
        $filterList = Concat($filterList, $this->Cover->AdvancedSearch->toJson(), ","); // Field Cover
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fsubmission_view2srch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Abstract
        $this->_Abstract->AdvancedSearch->SearchValue = @$filter["x__Abstract"];
        $this->_Abstract->AdvancedSearch->SearchOperator = @$filter["z__Abstract"];
        $this->_Abstract->AdvancedSearch->SearchCondition = @$filter["v__Abstract"];
        $this->_Abstract->AdvancedSearch->SearchValue2 = @$filter["y__Abstract"];
        $this->_Abstract->AdvancedSearch->SearchOperator2 = @$filter["w__Abstract"];
        $this->_Abstract->AdvancedSearch->save();
        ...
        // Field Cover
        $this->Cover->AdvancedSearch->SearchValue = @$filter["x_Cover"];
        $this->Cover->AdvancedSearch->SearchOperator = @$filter["z_Cover"];
        $this->Cover->AdvancedSearch->SearchCondition = @$filter["v_Cover"];
        $this->Cover->AdvancedSearch->SearchValue2 = @$filter["y_Cover"];
        $this->Cover->AdvancedSearch->SearchOperator2 = @$filter["w_Cover"];
        $this->Cover->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->Submission_ID, $default, false); // Submission_ID
        $this->buildSearchSql($where, $this->_Title, $default, false); // Title
        $this->buildSearchSql($where, $this->Category_ID, $default, false); // Category_ID
        $this->buildSearchSql($where, $this->Status, $default, false); // Status
        $this->buildSearchSql($where, $this->_Abstract, $default, false); // Abstract
        $this->buildSearchSql($where, $this->Tags, $default, true); // Tags
        $this->buildSearchSql($where, $this->Uploads, $default, false); // Uploads
        $this->buildSearchSql($where, $this->Cover, $default, false); // Cover
        $this->buildSearchSql($where, $this->Updated_Username, $default, false); // Updated_Username
        $this->buildSearchSql($where, $this->Updated_Last, $default, false); // Updated_Last
        $this->buildSearchSql($where, $this->Updated_IP, $default, false); // Updated_IP
        ...
        if (!$default && $this->Command == "search") {
            $this->Submission_ID->AdvancedSearch->save(); // Submission_ID
            $this->_Title->AdvancedSearch->save(); // Title
            $this->Category_ID->AdvancedSearch->save(); // Category_ID
            $this->Status->AdvancedSearch->save(); // Status
            $this->_Abstract->AdvancedSearch->save(); // Abstract
            $this->Tags->AdvancedSearch->save(); // Tags
            $this->Uploads->AdvancedSearch->save(); // Uploads
            $this->Cover->AdvancedSearch->save(); // Cover
            $this->Updated_Username->AdvancedSearch->save(); // Updated_Username
            $this->Updated_Last->AdvancedSearch->save(); // Updated_Last
            $this->Updated_IP->AdvancedSearch->save(); // Updated_IP
        }
        return $where;
    }
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->_Abstract;
        $searchFlds[] = &$this->Tags;
        $searchFlds[] = &$this->Uploads;
        $searchFlds[] = &$this->Cover;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->Submission_ID->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->_Abstract->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->Cover->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Updated_Username->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Updated_Last->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Updated_IP->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    {
        $this->Submission_ID->AdvancedSearch->unsetSession();
        $this->_Title->AdvancedSearch->unsetSession();
        $this->Category_ID->AdvancedSearch->unsetSession();
        $this->Status->AdvancedSearch->unsetSession();
        $this->_Abstract->AdvancedSearch->unsetSession();
        $this->Tags->AdvancedSearch->unsetSession();
        $this->Uploads->AdvancedSearch->unsetSession();
        $this->Cover->AdvancedSearch->unsetSession();
        $this->Updated_Username->AdvancedSearch->unsetSession();
        $this->Updated_Last->AdvancedSearch->unsetSession();
        $this->Updated_IP->AdvancedSearch->unsetSession();
    }
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->Submission_ID->AdvancedSearch->load();
        $this->_Title->AdvancedSearch->load();
        $this->Category_ID->AdvancedSearch->load();
        $this->Status->AdvancedSearch->load();
        $this->_Abstract->AdvancedSearch->load();
        $this->Tags->AdvancedSearch->load();
        $this->Uploads->AdvancedSearch->load();
        $this->Cover->AdvancedSearch->load();
        $this->Updated_Username->AdvancedSearch->load();
        $this->Updated_Last->AdvancedSearch->load();
        $this->Updated_IP->AdvancedSearch->load();
    }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fsubmission_view2list\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fsubmission_view2list\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fsubmission_view2srch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsubmission_view2srch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fsubmission_view2list"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
...
// Load basic search values
    ...
    protected function loadSearchValues()
    {
        ...
        // Submission_ID
        if ($this->Submission_ID->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Submission_ID->AdvancedSearch->SearchValue != "" || $this->Submission_ID->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // Category_ID
        if ($this->Category_ID->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Category_ID->AdvancedSearch->SearchValue != "" || $this->Category_ID->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // Abstract
        if ($this->_Abstract->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->_Abstract->AdvancedSearch->SearchValue != "" || $this->_Abstract->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // Tags
        if ($this->Tags->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Tags->AdvancedSearch->SearchValue != "" || $this->Tags->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        if (is_array($this->Tags->AdvancedSearch->SearchValue)) {
            $this->Tags->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->Tags->AdvancedSearch->SearchValue);
        }
        if (is_array($this->Tags->AdvancedSearch->SearchValue2)) {
            $this->Tags->AdvancedSearch->SearchValue2 = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->Tags->AdvancedSearch->SearchValue2);
        }
        ...
        // Cover
        if ($this->Cover->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Cover->AdvancedSearch->SearchValue != "" || $this->Cover->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // Updated_Username
        if ($this->Updated_Username->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Updated_Username->AdvancedSearch->SearchValue != "" || $this->Updated_Username->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // Updated_Last
        if ($this->Updated_Last->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Updated_Last->AdvancedSearch->SearchValue != "" || $this->Updated_Last->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // Updated_IP
        if ($this->Updated_IP->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Updated_IP->AdvancedSearch->SearchValue != "" || $this->Updated_IP->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->isExport()) {
                $this->Updated_Username->ViewValue = $this->highlightValue($this->Updated_Username);
            }
        } elseif ($this->RowType == ROWTYPE_SEARCH) {
            // Submission_ID
            $this->Submission_ID->setupEditAttributes();
            $this->Submission_ID->EditCustomAttributes = "";
            $this->Submission_ID->EditValue = HtmlEncode($this->Submission_ID->AdvancedSearch->SearchValue);
            ...
            $curVal = trim(strval($this->Category_ID->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->Category_ID->AdvancedSearch->ViewValue = $this->Category_ID->lookupCacheOption($curVal);
            } else {
                $this->Category_ID->AdvancedSearch->ViewValue = $this->Category_ID->Lookup !== null && is_array($this->Category_ID->lookupOptions()) ? $curVal : null;
            }
            if ($this->Category_ID->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->Category_ID->EditValue = array_values($this->Category_ID->lookupOptions());
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = "`Category_ID`" . SearchString("=", $this->Category_ID->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
            ...
            if (!$this->Updated_Username->Raw) {
                $this->Updated_Username->AdvancedSearch->SearchValue = HtmlDecode($this->Updated_Username->AdvancedSearch->SearchValue);
            }
            $this->Updated_Username->EditValue = HtmlEncode($this->Updated_Username->AdvancedSearch->SearchValue);
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fsubmission_view2srch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"fsubmission_view2srch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
