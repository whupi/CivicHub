...
// Use layout
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fuserssrch");
        }
        ...
        $filterList = Concat($filterList, $this->Report_To->AdvancedSearch->toJson(), ","); // Field Report_To
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Report_To); // Report_To
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->_Username->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("Report_To", $this->createColumnOption("Report_To"));
            $option->add("Activated", $this->createColumnOption("Activated"));
            $option->add("Locked", $this->createColumnOption("Locked"));
        }
