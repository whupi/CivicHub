    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            if ($deleteRow === false) {
                ...
                $this->rowDeleted($row);
                $successKeys[] = $thisKey;
                if ($x_User_Level_ID != null) {
                    $conn->executeStatement("DELETE FROM " . Config("USER_LEVEL_PRIV_TABLE") . " WHERE " . Config("USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD") . " = " . $x_User_Level_ID); // Delete user rights as well
                }
            }
        }
