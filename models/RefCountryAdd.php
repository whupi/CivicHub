 ...
 * Page class
 */
class RefCountryAdd extends RefCountry
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'ref_country';

    // Page object name
    public $PageObjName = "RefCountryAdd";
    ...
    public function __construct()
    {
        ...
        // Table object (ref_country)
        if (!isset($GLOBALS["ref_country"]) || get_class($GLOBALS["ref_country"]) == PROJECT_NAMESPACE . "ref_country") {
            $GLOBALS["ref_country"] = &$this;
        }

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'ref_country');
        }
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("refcountrylist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "refcountrylist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "refcountryview") {
...
// Get upload files
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("refcountrylist"), "", $this->TableVar, true);
