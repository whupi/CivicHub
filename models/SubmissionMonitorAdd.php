 ...
 * Page class
 */
class SubmissionMonitorAdd extends SubmissionMonitor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubmissionMonitorAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "submissionmonitorview") {
...
// Get upload files
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Organisations
        $this->Organisations->setDbValueDef($rsnew, $this->Organisations->CurrentValue, null, false);
