 ...
 * Page class
 */
class SubmissionView2View extends SubmissionView2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubmissionView2View";
...
// Is modal
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Submission_ID") ?? Route("Submission_ID")) !== null) {
                ...
                $returnUrl = "submissionview2list"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "submissionview2list"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "submissionview2list"; // Not page request, return to list
        }
        if ($returnUrl != "") {
