 ...
 * Page class
 */
class SubmissionVoteView extends SubmissionVote
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubmissionVoteView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Updated_Username") ?? Route("Updated_Username")) !== null) {
            $this->RecKey["Updated_Username"] = $keyValue;
        }
...
// Is modal
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Submission_ID") ?? Route("Submission_ID")) !== null) {
                ...
                $returnUrl = "submissionvotelist"; // Return to list
            }
            if (($keyValue = Get("Updated_Username") ?? Route("Updated_Username")) !== null) {
                $this->Updated_Username->setQueryStringValue($keyValue);
                $this->RecKey["Updated_Username"] = $this->Updated_Username->QueryStringValue;
            } elseif (Post("Updated_Username") !== null) {
                $this->Updated_Username->setFormValue(Post("Updated_Username"));
                $this->RecKey["Updated_Username"] = $this->Updated_Username->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "submissionvotelist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "submissionvotelist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
