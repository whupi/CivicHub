 ...
 * Page class
 */
class RefCategoryAddopt extends RefCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RefCategoryAddopt";
...
// Get upload files
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Category->IsDetailKey) {
            $this->Category->setFormValue(ConvertFromUtf8($val));
        }
        ...
        if (!$this->Category_Description->IsDetailKey) {
            $this->Category_Description->setFormValue(ConvertFromUtf8($val));
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->Category_Description->CurrentValue = ConvertToUtf8($this->Category_Description->FormValue);
    }
