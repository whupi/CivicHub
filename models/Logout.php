...
// Use layout
		...
		//$UserProfile->Profile[MS_USER_PROFILE_LAST_LOGOUT_DATE_TIME] = DbCurrentDateTime();
		$UserProfile->setValue(MS_USER_PROFILE_LAST_LOGOUT_DATE_TIME, StdCurrentDateTime());
