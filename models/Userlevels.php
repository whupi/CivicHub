...
class Userlevels extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->User_Level_ID->IsAutoIncrement = true; // Autoincrement field
        $this->User_Level_ID->IsPrimaryKey = true; // Primary key field
        ...
        // User_Level_Name
        $this->User_Level_Name = new DbField(
            'userlevels',
            'userlevels',
            'x_User_Level_Name',
            'User_Level_Name',
        ...
        $this->User_Level_Name->InputTextType = "text";
        $this->User_Level_Name->Nullable = false; // NOT NULL field
        $this->User_Level_Name->Required = true; // Required field
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "users") {
            ...
            $detailUrl .= "&" . GetForeignKeyUrl("fk_User_Level_ID", $this->User_Level_ID->CurrentValue);
        }
        if ($detailUrl == "") {
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->User_Level_ID->setDbValue($conn->lastInsertId());
            $rs['User_Level_ID'] = $this->User_Level_ID->DbValue;
        }
        return $success;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['User_Level_ID']) && $rsold['User_Level_ID'] != $rs['User_Level_ID'])) { // Update detail field 'User_Level'
            $cascadeUpdate = true;
            $rscascade['User_Level'] = $rs['User_Level_ID'];
        }
        if ($cascadeUpdate) {
            $rswrk = Container("users")->loadRs("`User_Level` = " . QuotedValue($rsold['User_Level_ID'], DATATYPE_NUMBER, 'DB'))->fetchAllAssociative();
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('User_Level_ID', $rs)) {
                AddFilter($where, QuotedName('User_Level_ID', $this->Dbid) . '=' . QuotedValue($rs['User_Level_ID'], $this->User_Level_ID->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("users")->loadRs("`User_Level` = " . QuotedValue($rs['User_Level_ID'], DATATYPE_NUMBER, "DB"))->fetchAllAssociative();
    ...
    {
        $keys = [];
        $val = $current ? $this->User_Level_ID->CurrentValue : $this->User_Level_ID->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->User_Level_ID->CurrentValue = $keys[0];
            } else {
                $this->User_Level_ID->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('User_Level_ID', $row) ? $row['User_Level_ID'] : null;
        } else {
            $val = $this->User_Level_ID->OldValue !== null ? $this->User_Level_ID->OldValue : $this->User_Level_ID->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@User_Level_ID@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("userlevelsedit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("userlevelsadd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $json = "";
        $json .= "\"User_Level_ID\":" . JsonEncode($this->User_Level_ID->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->User_Level_ID->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->User_Level_ID->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("User_Level_ID") ?? Route("User_Level_ID")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                ...
                $this->User_Level_ID->OldValue = $key;
            }
    ...
    public function renderEditRow()
    {
        ...
        $this->User_Level_ID->EditValue = FormatNumber($this->User_Level_ID->EditValue, $this->User_Level_ID->formatPattern());
        $this->User_Level_ID->ViewCustomAttributes = "";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->User_Level_Name);
                } else {
                    $doc->exportCaption($this->User_Level_ID);
                    $doc->exportCaption($this->User_Level_Name);
                }
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->User_Level_Name);
                    } else {
                        $doc->exportField($this->User_Level_ID);
                        $doc->exportField($this->User_Level_Name);
                    }
