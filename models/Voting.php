...
/**
 * Table class for Voting
 */
class Voting extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Voting';
        $this->TableName = 'Voting';
        $this->TableType = 'REPORT';

        // Update Table
        $this->UpdateTable = "`vote_tally`";
        $this->ReportSourceTable = 'vote_tally'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Submission_ID
        $this->Submission_ID = new ReportField(
            'Voting',
            'Voting',
            'x_Submission_ID',
            'Submission_ID',
        ...
        $this->Submission_ID->GroupingFieldId = 1;
        $this->Submission_ID->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->Submission_ID->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->Submission_ID->GroupByType = "";
        $this->Submission_ID->GroupInterval = "0";
        $this->Submission_ID->GroupSql = "";
        ...
        $this->Submission_ID->SourceTableVar = 'vote_tally';
        ...
        $this->_Title->SourceTableVar = 'vote_tally';
        $this->Fields['Title'] = &$this->_Title;

        // Votes
        $this->_Votes = new ReportField(
            'Voting',
            'Voting',
            'x__Votes',
            'Votes',
        ...
        $this->_Votes->InputTextType = "text";
        $this->_Votes->GroupingFieldId = 2;
        $this->_Votes->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->_Votes->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->_Votes->GroupByType = "";
        $this->_Votes->GroupInterval = "0";
        $this->_Votes->GroupSql = "";
        $this->_Votes->Lookup = new Lookup('Votes', 'Voting', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        $this->_Votes->OptionCount = 2;
        $this->_Votes->SourceTableVar = 'vote_tally';
        $this->Fields['Votes'] = &$this->_Votes;

        // Count
        $this->Count = new ReportField(
            'Voting',
            'Voting',
            'x_Count',
            'Count',
        ...
        $this->Count->SourceTableVar = 'vote_tally';
        $this->Fields['Count'] = &$this->Count;

        // Votes
        $this->Votes = new DbChart($this, 'Votes', 'Votes', 'Votes', 'Count', 1005, '', 0, 'COUNT', 600, 500);
        $this->Votes->YAxisFormat = ["Number"];
        $this->Votes->YFieldFormat = ["Number"];
        $this->Votes->SortType = 0;
        $this->Votes->SortSequence = "";
        $this->Votes->SqlSelect = $this->getQueryBuilder()->select("`Votes`", "''", "COUNT(`Count`)");
        $this->Votes->SqlGroupBy = "`Votes`";
        $this->Votes->SqlOrderBy = "";
        $this->Votes->SeriesDateType = "";
        $this->Votes->ID = "Voting_Votes"; // Chart ID
        $this->Votes->setParameters([
            ["type", "1005"],
            ["seriestype", "0"]
        ]); // Chart type / Chart series type
        $this->Votes->setParameters([
            ["caption", $this->Votes->caption()],
            ["xaxisname", $this->Votes->xAxisName()]
        ]); // Chart caption / X axis name
        $this->Votes->setParameter("yaxisname", $this->Votes->yAxisName()); // Y axis name
        $this->Votes->setParameters([
            ["shownames", "1"],
            ["showvalues", "1"],
            ["showhovercap", "1"]
        ]); // Show names / Show values / Show hover
        $this->Votes->setParameter("alpha", "50"); // Chart alpha
        $this->Votes->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "submission_vote") {
            $detailUrl = Container("submission_vote")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->Submission_ID;
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("COUNT(*) AS `cnt_count`");
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`vote_tally`";
    }
