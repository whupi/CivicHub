 ...
 * Page class
 */
class RefCategoryEdit extends RefCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RefCategoryEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("refcategorylist"); // No matching record, return to list
                        return;
                    }
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "refcategorylist") {
...
// Get upload files
    ...
    protected function validateForm()
    {
        ...
        if (in_array("submission", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            if ($editRow) {
                $detailPage = Container("SubmissionGrid");
                if (in_array("submission", $detailTblVar) && $detailPage->DetailEdit) {
                    $Security->loadCurrentUserLevel($this->ProjectID . "submission"); // Load user level of detail table
    ...
    protected function setupDetailParms()
    {
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("submission", $detailTblVar)) {
                $detailPageObj = Container("SubmissionGrid");
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("refcategorylist"), "", $this->TableVar, true);
        $pageId = "edit";
