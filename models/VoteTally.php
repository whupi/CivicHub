...
/**
 * Table class for vote_tally
 */
class VoteTally extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'vote_tally';
        $this->TableName = 'vote_tally';
        $this->TableType = 'VIEW';
        ...
        $this->Votes->InputTextType = "text";
        $this->Votes->Lookup = new Lookup('Votes', 'vote_tally', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        $this->Votes->OptionCount = 2;
        $this->Fields['Votes'] = &$this->Votes;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("votetallylist");
    }
    ...
    {
        global $Language;
        if ($pageName == "votetallyview") {
            return $Language->phrase("View");
        } elseif ($pageName == "votetallyedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "votetallyadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VoteTallyView";
            case Config("API_ADD_ACTION"):
                return "VoteTallyAdd";
            case Config("API_EDIT_ACTION"):
                return "VoteTallyEdit";
            case Config("API_DELETE_ACTION"):
                return "VoteTallyDelete";
            case Config("API_LIST_ACTION"):
                return "VoteTallyList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("votetallyview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("votetallyview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "votetallyadd?" . $this->getUrlParm($parm);
        } else {
            $url = "votetallyadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("votetallyedit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("votetallyedit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("votetallyadd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("votetallyadd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("votetallydelete", $this->getUrlParm());
    }
