 ...
 * Page class
 */
class RefCategoryDelete extends RefCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RefCategoryDelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("refcategorylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("refcategorylist"); // Return to list
                return;
            }
        }
