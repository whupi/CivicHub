 ...
 * Page class
 */
class SubmissionMonitorDelete extends SubmissionMonitor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubmissionMonitorDelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("submissionmonitorlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("submissionmonitorlist"); // Return to list
            return;
        }
