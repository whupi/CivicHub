 ...
 * Page class
 */
class SubmissionView2Delete extends SubmissionView2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubmissionView2Delete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("submissionview2list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("submissionview2list"); // Return to list
            return;
        }
