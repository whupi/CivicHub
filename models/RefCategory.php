...
/**
 * Table class for ref_category
 */
class RefCategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'ref_category';
        $this->TableName = 'ref_category';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`ref_category`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "submission") {
            $detailUrl = Container("submission")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_Category_ID", $this->Category_ID->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "refcategorylist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`ref_category`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("refcategorylist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "refcategoryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "refcategoryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "RefCategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "RefCategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "RefCategoryDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("refcategoryview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("refcategoryview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "refcategoryadd?" . $this->getUrlParm($parm);
        } else {
            $url = "refcategoryadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("refcategoryedit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("refcategoryedit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("refcategoryadd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("refcategoryadd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("refcategorydelete", $this->getUrlParm());
    }
