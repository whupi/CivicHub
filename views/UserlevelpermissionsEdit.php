...
<input type="hidden" data-table="userlevelpermissions" data-field="x_User_Level_ID" data-hidden="1" name="o_User_Level_ID" id="o_User_Level_ID" value="<?= HtmlEncode($Page->User_Level_ID->OldValue ?? $Page->User_Level_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="userlevelpermissions" data-field="x_Table_Name" data-hidden="1" name="o_Table_Name" id="o_Table_Name" value="<?= HtmlEncode($Page->Table_Name->OldValue ?? $Page->Table_Name->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
