...
<?php if ($Page->User_Level_ID->Visible) { // User_Level_ID ?>
        <th data-name="User_Level_ID" class="<?= $Page->User_Level_ID->headerCellClass() ?>"><div id="elh_userlevelpermissions_User_Level_ID" class="userlevelpermissions_User_Level_ID"><?= $Page->renderFieldHeader($Page->User_Level_ID) ?></div></th>
<?php } ?>
<?php if ($Page->Table_Name->Visible) { // Table_Name ?>
        <th data-name="Table_Name" class="<?= $Page->Table_Name->headerCellClass() ?>"><div id="elh_userlevelpermissions_Table_Name" class="userlevelpermissions_Table_Name"><?= $Page->renderFieldHeader($Page->Table_Name) ?></div></th>
<?php } ?>
...
loadjs.ready("jqueryjs", function() {
	...
	if (Cookies.get('userlevelpermissions_searchpanel')=="active") { 
		SearchToggle.addClass(Cookies.get('userlevelpermissions_searchpanel')); 
		SearchPanel.removeClass('collapse'); 
		SearchPanel.addClass('show'); 
		SearchToggle.addClass('active'); 
		SearchToggle.attr('aria-pressed', 'true'); 
	} else if (Cookies.get('userlevelpermissions_searchpanel')=="notactive") { 
	...
	SearchToggle.on('click', function(event) { 
		...
		if (SearchToggle.hasClass('active')) { 
			SearchToggle.removeClass('active'); 
			SearchToggle.attr('aria-pressed', 'true');
			Cookies.set("userlevelpermissions_searchpanel", "notactive", { path: '', expires: expires }); 
		} else { 
			SearchToggle.addClass('active'); 		
			SearchToggle.attr('aria-pressed', 'false'); 
			Cookies.set("userlevelpermissions_searchpanel", "active", { path: '', expires: expires }); 
		} 
	});
});
</script>
