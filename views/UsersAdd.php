...
loadjs.ready(["wrapper", "head"], function () {
    ...
    fusersadd.lists.Report_To = <?= $Page->Report_To->toClientList($Page) ?>;
    fusersadd.lists.Activated = <?= $Page->Activated->toClientList($Page) ?>;
    fusersadd.lists.Locked = <?= $Page->Locked->toClientList($Page) ?>;
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->Activated->isInvalidClass() ?>" data-table="users" data-field="x_Activated" name="x_Activated[]" id="x_Activated_644926" value="1"<?= ConvertToBool($Page->Activated->CurrentValue) ? " checked" : "" ?><?= $Page->Activated->editAttributes() ?> aria-describedby="x_Activated_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->Locked->isInvalidClass() ?>" data-table="users" data-field="x_Locked" name="x_Locked[]" id="x_Locked_678865" value="1"<?= ConvertToBool($Page->Locked->CurrentValue) ? " checked" : "" ?><?= $Page->Locked->editAttributes() ?> aria-describedby="x_Locked_help">
