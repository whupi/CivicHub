...
(function (global, factory) {
  ...
  var CardRefresh = /*#__PURE__*/function () {
    ...
    CardRefresh._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $__default['default'].extend({}, Default$c, $__default['default'](this).data(), typeof config === 'object' ? config : {}); //***
  ...
  var EVENT_COLLAPSED$2 = "collapsed" + EVENT_KEY$3; // const SELECTOR_TABLE = '.expandable-table'
  ...
  var ExpandableTable = /*#__PURE__*/function () {
    ...
    ExpandableTable._jQueryInterface = function _jQueryInterface(operation, relatedTarget) {
      return this.each(function () {
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto._fixHeight = function _fixHeight(tabEmpty) {
      ...
      if ($__default['default']('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
        ...
        if (tabEmpty == true) {
          setTimeout(function () {
            $__default['default'](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING).height(contentWrapperHeight + 100 - _navbarHeight);
          }, 50);
        } else {
    ...
    _proto.fixLayoutHeight = function fixLayoutHeight(extra) {
      ...
      if (offset !== false) {
        if (max === heights.controlSidebar) {
          $contentSelector.css(this._config.panelAutoHeightMode, max + 100 + offset);
        } else if (max === heights.window) {
          $contentSelector.css(this._config.panelAutoHeightMode, max + 100 + offset - heights.header - heights.footer);
        } else {
          $contentSelector.css(this._config.panelAutoHeightMode, max + 100 + offset - heights.header);
        }
  ...
  var PushMenu = /*#__PURE__*/function () {
    ...
    _proto.expand = function expand() {
      ...
      if (this._options.enableRemember) {
		...
		// Begin of modification by Masino Sinaga, September 18, 2021
		var expires = new Date(new Date().getTime() + 525600 * 60 * 1000); // expire in 525600 
		Cookies.set('aside_toggle_state', "expanded", { path: '', expires: expires });
		// End of modification by Masino Sinaga, September 18, 2021
      }
  ...
  var SELECTOR_CONTAINER_BOTTOM_LEFT = '#toastsContainerBottomLeft'; // const CLASS_NAME_TOP_RIGHT = 'toasts-top-right'
